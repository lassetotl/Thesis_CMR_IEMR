...
def strain(strain_rate, weight = 10):
    ...
    strain = cumulative_trapezoid(strain_rate[:T_ed], range_TR[:T_ed], initial=0)
    strain_flipped = np.flip(cumulative_trapezoid(strain_rate[:T_ed][::-1], range_TR[:T_ed][::-1], initial=0))
